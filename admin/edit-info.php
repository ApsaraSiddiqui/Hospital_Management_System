...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"Update detail set name='$dname',disease='$dd',prevent='$dp',cure='$dc' where id='$did'");
	if($sql)
	{
...
<html lang="en">
<head>
	<title>Admin | Edit Info Details</title>
...
<body class="nav-md">
	<?php
	$page_title = 'Admin | Edit Info Details';
	$x_content = true;
	?>
					...
					<div class="col-lg-8 col-md-12">
						<div class="panel panel-white">
							<div class="panel-heading">
								<h5 class="panel-title">Edit  info</h5>
							</div>
							<div class="panel-body">
								<?php $sql=mysqli_query($con,"select * from detail where id='$did'");
								while($data=mysqli_fetch_array($sql))
								{
									?>
									<h4><?php echo htmlentities($data['name']);?>'s Information</h4>
